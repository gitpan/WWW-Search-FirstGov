# This Makefile is for the WWW::Search::FirstGov extension to perl.
#
...
#	NAME => q[WWW::Search::FirstGov]
#	PREREQ_PM => { WWW::Search=>q[2.28] }
#	VERSION_FROM => q[FirstGov.pm]
...
DISTNAME = WWW-Search-FirstGov
NAME_SYM = WWW_Search_FirstGov
VERSION = 1.12
VERSION_SYM = 1_12
XS_VERSION = 1.12
INST_BIN = blib/bin
...
FULLEXT = WWW/Search/FirstGov
BASEEXT = FirstGov
PARENT_NAME = WWW::Search
DLBASE = $(BASEEXT)
VERSION_FROM = FirstGov.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/WWW/Search
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/WWW/Search
...
TO_INST_PM = FirstGov.pm

PM_TO_BLIB = FirstGov.pm \
	$(INST_LIBDIR)/FirstGov.pm
...
manifypods : pure_all FirstGov.pm
	@$(POD2MAN) \
	FirstGov.pm \
	$(INST_MAN3DIR)/WWW::Search::FirstGov.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"WWW-Search-FirstGov\" VERSION=\"1,12,0,0\">\n}. qq{\t<TITLE>WWW-Search-FirstGov</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"WWW-Search\" VERSION=\"2,28,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > WWW-Search-FirstGov.ppd
